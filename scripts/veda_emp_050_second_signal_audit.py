...
AUDIT = {
    ...
    "second_signal_found": True,
    "decision": "SECOND_SIGNAL_FROZEN",
    "second_signal": {
        ...
        "pilot_ready": False,
        "pilot_blocker": "No eligible signal-specific historical cases currently registered; acquire before scoring.",
    },
    "candidates": [
        {
            "domain": "PROGENY",
            "status": "SOURCE_GOVERNABLE",
            "blockers": ["D7 interpretation remains excluded", "signal is research-only and requires signal-specific cases before a pilot"],
        },
        {
            "domain": "EDUCATION",
