    ...
    def blueprints(self) -> list[CapabilityBlueprint]:
        return [
            ...
            CapabilityBlueprint(
                ...
                initial_status=CapabilityStatus.IMPLEMENTING,
                activation_state=ActivationState.INACTIVE,
                research_status="FOUNDATION_AUDIT_COMPLETED_WITH_CONDITIONS",
                knowledge_status="PARTIAL_SOURCE_GOVERNANCE",
                implementation_status="FOUNDATION_ONLY_NO_ELECTIONAL_SELECTION",
                validation_status="PARTIAL_FOUNDATION_VALIDATED",
                required_chart_facts=["date", "location", "timezone", "sunrise", "sunset", "tithi", "nakshatra"],
                required_sources=["CLASSICAL_PRIMARY"],
                ...
                implementation_module="engines.ai.knowledge.muhurta_foundation",
            ),
        ]
