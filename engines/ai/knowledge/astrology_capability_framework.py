    ...
    def blueprints(self) -> list[CapabilityBlueprint]:
        return [
            ...
            CapabilityBlueprint(
                ...
                initial_status=CapabilityStatus.BLOCKED,
                activation_state=ActivationState.INACTIVE,
                research_status="LEGACY_SCHEMA_MAPPING_EXISTS_BUT_PROVENANCE_INCOMPLETE",
                knowledge_status="MISSING_APPROVED_CORE_FOR_DIGNITY_RULES",
                implementation_status="DRAFT_RULE_PRESENT",
                validation_status="BLOCKED_PENDING_APPROVED_CORE",
                required_chart_facts=["graha_longitudes", "rashi", "degrees_in_sign"],
                required_rules=["VEDA-RUL-DIGNITY-000001"],
                required_sources=["CLASSICAL_PRIMARY", "TRADITIONAL_SECONDARY"],
                runtime_profile_support=["PERSONAL", "REST_STANDARD", "STOCK_MARKET", "COUNTRY_EVENT"],
                draft_rule_ids=["VEDA-RUL-DIGNITY-000001"],
                legacy_mapping_ids=["VEDA-LMP-000002"],
                dependencies=["VEDA-CAP-FOUNDATION-000001", "VEDA-CAP-FOUNDATION-000002"],
                ...
                confidence=CapabilityConfidenceDimensions(
                    ...
                    production_confidence=0.15,
                ),
                notes="Pilot capability remains blocked because the draft dignity rule is still legacy-unsourced and no approved-core dignity claim is linked.",
                implementation_module="engines/intelligence/kundli_engine.py::KundliEngine._dignity",
            ),
            CapabilityBlueprint(
    ...
    def pilot_capability(self) -> dict[str, Any]:
        ...
        return {
            **_artifact_meta(),
            ...
            "governance_outcome": "BLOCKED_WITH_EXPLICIT_REASON",
        }
