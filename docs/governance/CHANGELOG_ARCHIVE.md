...
Older entries moved out of `CHANGELOG.md` on 2026-07-19 to keep the active changelog small (session-context / token-budget hygiene -- see `docs/governance/CHANGELOG.md` for current entries and rationale).
