...
- VEDA-KNOW-SPIRIT-001 is `PASS_WITH_CONDITION`; P015-RX2 now routes D20 through the versioned BPHS category-start method with calculation status `PARTIALLY_VALIDATED`, while destination mapping and interpretation remain separately gated.
