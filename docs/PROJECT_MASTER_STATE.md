...
- VEDA-EMP-050-SIGNAL-SEARCH-001 is active at 25/50 eligible cases. VEDA-SIGNAL-BREAKTHROUGH-001 established the first narrow source-governable marriage-occurrence contract, but its independent marriage sample is zero and no pilot is ready. Subject-first plus provenance-only event-first acquisition continue without consuming the EMP-025 holdout.
