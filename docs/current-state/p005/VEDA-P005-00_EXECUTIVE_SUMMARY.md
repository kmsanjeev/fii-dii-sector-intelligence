...
- Interpretation surfaces: `14`
- Legacy rules inventoried: `32`
- Source-validated legacy rules: `1`
- Unsourced legacy rules: `18`
- Yoga rows audited: `13`
- Dosha rows audited: `5`
- Traceability cases: `6` (`1` complete)
- P0 high-stakes findings: `3`

Representative runtime evidence under frozen `2026-08-10`:
