# Future Jyotisha Capability Candidates

These are candidates, not authorized phases:

| Candidate | Status | Evidence / dependency |
|---|---|---|
...
No candidate receives P027 without a separate scope decision.
