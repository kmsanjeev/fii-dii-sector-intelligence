...
**Dependencies:** EMP-001, existing case registry, prediction/outcome contracts, provenance and leakage validation, admin authorization.

**Readiness:** IMPLEMENTED / FROZEN. The next step is data acquisition and review, with privacy/consent, provenance, duplicate semantics, and sample quality verified at intake. P027 remains reserved and is not started.
