...
- Empirical status: `VEDA-EMP-001` remains longitudinal; EMP-025-R2 has 21 eligible and chart-ready historical cases across five event classes, with the method pilot still blocked by the 25-case count gate; `PRED-M4` is `INSUFFICIENT_SAMPLE`.
