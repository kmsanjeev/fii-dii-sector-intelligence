...
The implemented baseline is frozen through P026 plus STD-001, STD-002, and PRED-001 through PRED-003. P027 is reserved but unassigned. STD-003 and ADM-EMP-001 are captured as future work, not implemented.
