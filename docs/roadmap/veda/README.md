...
- Empirical status: `VEDA-EMP-001` remains longitudinal; EMP-025 has 10 eligible historical cases and 10 D1 chart snapshots, but remains below the multi-class corpus gate; `PRED-M4` is `INSUFFICIENT_SAMPLE`.
