...
The implemented baseline is frozen through P030 plus P015-RX, STD-001, STD-002, STD-003, and PRED-001 through PRED-003. P027 Advanced Synthesis & Multi-Chart Reasoning, P028 Compatibility & Relationship Synthesis, P028-R1 Traditional Compatibility Methods, P029 Property, Residence & Real-Estate Synthesis, P015-RX D4 Calculation Remediation, and P030 Travel, Relocation & Foreign Residence Synthesis are implemented/frozen. VEDA-KNOW-COMPAT-001 and VEDA-KNOW-PROP-001 remain `PASS_WITH_CONDITION`; VEDA-KNOW-TRAVEL-001 is in implementation with a `PASS_WITH_CONDITION` decision and method-scoped movement evidence. D4 calculation is validated for the selected method, while D4 interpretation remains not validated. P029-R1, P030-R1 and P031 are not started. ADM-EMP-001 is implemented/frozen; EMP-001 remains longitudinal.
