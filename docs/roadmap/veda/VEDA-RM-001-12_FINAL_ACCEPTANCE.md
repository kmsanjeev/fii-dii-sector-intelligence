...
| `docs/current-state/lang-001/` and `tests/fixtures/veda_lang001_benchmark.json` | LANG-001 implementation | Records the Wave-1 expression registry, contextual resolver, benchmark, limitations, and acceptance evidence | Current | LANG-001 freeze commit/tag |
