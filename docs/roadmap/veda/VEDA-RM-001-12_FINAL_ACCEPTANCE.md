...
| `docs/current-state/comm-001/` and `tests/fixtures/veda_comm001_transitions.json` | COMM-001 implementation | Records the operational analyzer, benchmark, fallback, limitations, and acceptance evidence | Current | COMM-001 freeze commit/tag |
