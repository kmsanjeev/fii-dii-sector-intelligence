...
def _stock_summary(symbol: str, contract: dict[str, Any], sector: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "corporate_event_context": {
            ...
            "results_context": facts.get("corporate", {}).get("results_context", {}),
            "retrieval_metadata": facts.get("corporate", {}).get("retrieval_metadata", {}),
            "lifecycle_coverage": facts.get("corporate", {}).get("lifecycle_coverage", {}),
        },
